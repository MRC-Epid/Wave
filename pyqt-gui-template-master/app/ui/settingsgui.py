...
# Form implementation generated from reading ui file 'C:\Users\Cobin\Desktop\pyqt-gui-template-master\tools\\..\app\ui\settings_v2.ui'
#
...
class Ui_settingsWindow(object):
    def setupUi(self, settingsWindow):
        ...
        settingsWindow.resize(650, 800)
        settingsWindow.setMinimumSize(QtCore.QSize(650, 800))
        settingsWindow.setMaximumSize(QtCore.QSize(2000, 2000))
        self.centralwidget = QtWidgets.QWidget(settingsWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.groupBox_2 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_2.setGeometry(QtCore.QRect(9, 9, 650, 750))
    ...
    def retranslateUi(self, settingsWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("logo_2.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
        ...
        self.defaultsettingsPush.setText(_translate("settingsWindow", "Default"))
