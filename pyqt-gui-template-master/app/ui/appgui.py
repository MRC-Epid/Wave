...
# Form implementation generated from reading ui file 'C:\Users\Administrator\Desktop\pyqt-gui-template-master\tools\\..\app\ui\app.ui'
#
...
class Ui_MainWindow(object):
    ...
    def manualfoldersubmit(self):
        ...
        QMessageBox.question(self, 'Wave: Folder Entry', "Output Folder: " + textboxValue, QMessageBox.Ok, QMessageBox.Ok)
    ...
    def run(self):
        ...
        for row in range(Ui_MainWindow.pass_table_count):
            ...
            try:
                ...
                #if filename_short != "":
                #   self.update_error.emit('Error: No File Found')
                #    break
